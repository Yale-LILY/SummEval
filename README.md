...
Each source news article comes with the original reference from the CNN/DailyMail dataset and 9 additional crowdsources reference summaries.
...
@article{fabbriSummEval2020,
  author    = {Alexander R. Fabbri and Wojciech Kry{\'s}ci{\'n}ski and Dragomir Radev and Richard Socher},
